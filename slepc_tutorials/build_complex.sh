...
-I/home/efefer/mysoftwares/slepc-3.20.1-complex/include \
-I/home/efefer/mysoftwares/petsc-3.20.3-complex/include \
-Wl,-export-dynamic $1 \
-Wl,-rpath,/home/efefer/mysoftwares/slepc-3.20.1-complex/lib -L/home/efefer/mysoftwares/slepc-3.20.1-complex/lib -lslepc \
...
-lpetsc -llapack -lblas -lm -lX11 -ldl -lmpi_usempif08 -lmpi_usempi_ignore_tkr \
-lmpi_mpifh -lmpi -lgfortran -lm -lgfortran -lm -lgcc_s -lquadmath -lpthread -lstdc++ \
-lquadmath -ldl -o "${basnam}"_complex.x
