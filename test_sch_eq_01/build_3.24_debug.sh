...
PETSC_HOME="../install/petsc-3.24.2"
SLEPC_HOME="../install/slepc-3.24.1"
...
-lslepc -lpetsc -llapack -lblas -lm -ldl -lmpi_usempif08 -lmpi_usempi_ignore_tkr -lmpi_mpifh -lmpi \
