/*=============================================================================================
  ...
  | file name: forces.cc
  |
  | Description: This file contains the functions required for calculation of
  local component of | force, force correction and nonlocal component of force
  |
...
PetscErrorCode kPointPeriodicForce_Nonlocal(SDDFT_OBJ *pSddft) {
  ...
  for (k = 0; k < pSddft->Nkpts_sym; k++) {
    ...
    MatMatMultSymbolic(pSddft->gradient_x, pSddft->XOrb1[k], PETSC_DEFAULT,
                       &pSddft->YOrb1[k]);
    MatMatMultNumeric(pSddft->gradient_x, pSddft->XOrb1[k], pSddft->YOrb1[k]);
    MatMatMultSymbolic(pSddft->gradient_x, pSddft->XOrb2[k], PETSC_DEFAULT,
                       &pSddft->YOrb2[k]);
