/*=============================================================================================
  ...
  |
  | Description: This file contains the Fermi-Dirac function, constraint on
  electronic | occupations, brent's root finding algorithm for calculation of
  fermi energy and function | for subspace rotation
  |
